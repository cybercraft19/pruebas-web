...
class PruebasReferenciaSeeder extends Seeder
{
    ...
    public function crearEstilosAprendizaje(User $evaluador): void
    {
        ...
        $preguntas = [
            ...
            ['¿Cómo te consideras tú?', ['Muy activo (te encantan los deportes, correr y moverte)', 'Inteligente (te gusta aprender cosas nuevas, leer o armar rompecabezas)', 'Amiguero (te encanta platicar, conocer gente y estar acompañado)'], ['visual', 'auditivo', 'cinestesico']],
            ...
            ['¿Con cuál de estas frases estás más de acuerdo cuando usas tu bicicleta, monopatín o tus tenis favoritos?', ['Me encanta sentir la velocidad y lo cómodo o suave que se siente al usarlo.', 'Noto enseguida cualquier ruidito extraño que haga al avanzar.', 'Me importa mucho que se vea limpio, brillante y sin manchas de lodo.'], ['cinestesico', 'auditivo', 'visual']],
            ['¿Cómo prefieres pasar el tiempo con tu mejor amigo o amiga?', ['Platicando o contando chistes', 'Jugando o compartiendo', 'Mirando una película o videos juntos'], ['auditivo', 'cinestesico', 'visual']],
            ...
            ['¿Qué te parece más emocionante o genial?', ['Una habitación con luces de colores o compartida a oscuras con linternas', 'Un olor delicioso, como a chocolate o a chicle', 'Escuchar tu música o canciones favoritas'], ['visual', 'cinestesico', 'auditivo']],
            ...
            ['¿Qué te llama más la atención cuando conoces a un nuevo amigo o amiga?', ['Que sea buena onda, amable y te trate bien', 'Su ropa, su peinado o los juguetes que lleva', 'Las cosas que cuenta, sus historias y su forma de hablar'], ['cinestesico', 'visual', 'auditivo']],
            ...
            ['¿Cómo sería tu plan perfecto para una noche divertida?', ['Acampando en la sala con una tienda de campaña o un fuerte de cobijas', 'Teniendo una fiesta con luces de colores y música para bailar', 'Jugando juegos de mesa o videojuegos tranquilamente'], ['visual', 'auditivo', 'cinestesico']],
